...
<body>
   ...
   <section id="sidebar"> 
        ...
        <div id="sidebar-nav">   
          <ul>
            <li><a href="../admindash.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="listpesanan.php"><i class="pesanan"></i> Pemesanan</a></li>
...
var data = [],
    ...
    h, 
    m,
    names = ['HILUX', 'L300', 'TRITON', 'CR-V', 'CANTER', 'LIBUR', 'HILUX', 'FORTUNER', 'XENIA'],
